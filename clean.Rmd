...
WM2 <- WM %>%  select(ID, Field,  Year, State,County, Host, Source, Group_MOA_current_season, Rate,  Country, DNA.Extraction, lat, long, Selection_fungicides, DNA.Extraction ) %>%
