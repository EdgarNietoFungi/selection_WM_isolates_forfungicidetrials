...
```{r}
###
WM <- read.csv("data/WM-fixingproductnamesID2573_modifyingforactiveingredient_3.csv", stringsAsFactors = TRUE)# Making the columns as 
...
levels(soybeans_tested$Group_MOA_current_season) = c("Group_11" , "Group_3", "Group_3&Group_11", "Group_3&Group_7", "Group_3&not_considered_group", "Group_7", "Group_7&Group_11","Group_one", "unknown", "no fungicide" )
...
```{r}
#generalized summary
a <- wm1_ %>% filter(State== "IA" ) %>% select(Host, State, County, Field, Origin, Collection_ID, Form.ID, long, lat, Fungicide_current_season, Fungicide_previous_seasons, Group_MOA_current_season, Group_MOA_previous_seasons, Year) %>% filter(Origin == "fungicide field trials") %>%group_by(Field)  %>% filter(n() > 9) %>% ungroup() %>%  group_by(County, Year) %>% summarize(N=n())
...
b <- wm1_ %>% filter(State== "WI" ) %>% select(Host, State, County, Field, Origin, Collection_ID, Form.ID, long, lat, Fungicide_current_season, Fungicide_previous_seasons, Year) %>% filter(Origin == "fungicide field trials") %>%
  ...
  group_by(County, Year) %>% summarize(N=n())
                                                             c <- wm1_ %>% filter(State== "MI" ) %>% select(Host, State, County, Field,  Origin, Collection_ID, Form.ID, long, lat, Fungicide_current_season, Fungicide_previous_seasons, Year) %>% filter(Origin == "fungicide field trials")%>%group_by(Field)  %>% filter(n() > 9) %>% ungroup() %>% group_by(County, Year) %>% summarize(N=n())                 
```

```{r}

a_a <- wm1_ %>% filter(State== "IA" ) %>% select( State, County, Field,Year,  Origin, Collection_ID, Form.ID, long, lat, Fungicide_current_season,  Group_MOA_current_season, Group_MOA_previous_seasons) %>% filter(Origin == "fungicide field trials") %>%group_by(Field)  %>% filter(n() > 9) %>% ungroup()%>% select( State, County, Field,Year,  long, lat, Group_MOA_current_season) %>% group_by(State, Field, Year, Group_MOA_current_season) %>% summarize(N=n()) %>% filter(!Group_MOA_current_season == "unknown")

b_b <- wm1_ %>% filter(State== "WI" ) %>% select( State, County, Field,Year,  Origin, Collection_ID, Form.ID, long, lat, Fungicide_current_season,  Group_MOA_current_season, Group_MOA_previous_seasons) %>% filter(Origin == "fungicide field trials") %>%group_by(Field)  %>% filter(n() > 9) %>% ungroup()%>% select( State, County, Field,Year,  long, lat, Group_MOA_current_season) %>% group_by(State, Field, Year, Group_MOA_current_season) %>% summarize(N=n()) %>% 
