...
selection3$Status[selection3$Collection_ID == "2344"] <- "selected"
selection3$Status[selection3$Collection_ID == "2403"] <- "selected"
...
Results will be useful for inferring mechanisms of spread and evolution of the pathogen, which enable us to answer questions, such as: Is there evidence that Mexico is the point of origin of S. sclerotiorum? Is there evidence of sexual outcrossing in Mexico, possibly due to more conducive environmental conditions?
