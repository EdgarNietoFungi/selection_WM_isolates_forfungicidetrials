...
baseline_isolates <- c("1","118", "123", "12B", "129", "20", "21", "449", "461", "467", "475", "558", "564", "568", "581", "645", "800", "667", "74-SS-1", "8", "87")
...
levels(wm1_$Origin) = c("", "Farmer fields", "Fungicide field trials", "White mold nursery")#, "Farmer fields before fungicides lunched")


wm1_[(which(wm1_$Collection_ID %in% white_mold_nursery)), 5] <- "White mold nursery"

#wm1_[(which(wm1_$Collection_ID %in% survey_before_fungicides_lunched)), 5] <- "Farmer fields before fungicides lunched"
