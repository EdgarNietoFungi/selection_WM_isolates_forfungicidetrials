...
drybeans_tested <- wm1_%>% select(Collection_ID, State, County, Country, Origin, Year, Fungicide_status, Host, Group_MOA_current_season, Group_MOA_previous_seasons) %>% filter(Fungicide_status == "tested", Host== "drybeans") %>% group_by(State, Origin, Group_MOA_current_season, Group_MOA_previous_seasons) %>% summarize(n=n())
...
wm2 <- wm2 %>% group_by(Field) %>% mutate (num_isolates_per_field = ifelse(n() > 9, ">9isolates/Field", "<9isolates/Field")) %>% filter(num_isolates_per_field ==">9isolates/Field") 
...
wm4 <- wm4 %>% group_by(Field) %>% mutate (num_isolates_per_field = ifelse(n() > 9, ">9isolates/Field", "<9isolates/Field")) %>% filter(num_isolates_per_field ==">9isolates/Field") 
...
wm5 <- wm5 %>% group_by(Field) %>% mutate (num_isolates_per_field = ifelse(n() > 9, ">9isolates/Field", "<9isolates/Field")) %>% filter(num_isolates_per_field ==">9isolates/Field") 
