...
b_Group_unknown <- st_as_sf(a, coords = c("long", "lat"))
...
dist_matrix_Group_1 <- b_Group_1%>% 
  ...
  mutate("hol" = as.numeric(dist_m_Group_1[, 1]), 
                       "mad" = as.numeric(dist_m_Group_1[, 2]),
                       "madi" = as.numeric(dist_m_Group_1[, 3]),
                       "ant" = as.numeric(dist_m_Group_1[, 4]),
                       "ante" = as.numeric(dist_m_Group_1[, 5]),
      "wau" = as.numeric(dist_m_Group_1[, 6])   
         )

dist_matrix_Group_3  <- b_Group_3%>%
mutate("dod" = as.numeric(dist_m_Group_3[, 1]),
"do" = as.numeric(dist_m_Group_3[, 2]),
"holt" = as.numeric(dist_m_Group_3[, 3]),
"hol" = as.numeric(dist_m_Group_3[, 4]),
"8" = as.numeric(dist_m_Group_3[, 5]),
"19" = as.numeric(dist_m_Group_3[, 6]),
"20" = as.numeric(dist_m_Group_3[, 7]),
"34" = as.numeric(dist_m_Group_3[, 8]),
"45" = as.numeric(dist_m_Group_3[, 9]),
"46" = as.numeric(dist_m_Group_3[, 10]),
"48" = as.numeric(dist_m_Group_3[, 11]),
"48" = as.numeric(dist_m_Group_3[, 12]),
"66" = as.numeric(dist_m_Group_3[, 13]),
"67" = as.numeric(dist_m_Group_3[, 14]),
"78" = as.numeric(dist_m_Group_3[, 15]),
"97" = as.numeric(dist_m_Group_3[, 16]),
"98" = as.numeric(dist_m_Group_3[, 17]),
"101"= as.numeric(dist_m_Group_3[, 18]),
"be" = as.numeric(dist_m_Group_3[, 19]),
"bee" = as.numeric(dist_m_Group_3[, 20]),
"beee" = as.numeric(dist_m_Group_3[, 21]),
"beee" = as.numeric(dist_m_Group_3[, 22]))
...
"do" = as.numeric(dist_m_Group_11[, 2]),
"ant" = as.numeric(dist_m_Group_11[, 3]),
"6" = as.numeric(dist_m_Group_11[, 4]),
"8" = as.numeric(dist_m_Group_11[, 5]),
"18" = as.numeric(dist_m_Group_11[, 6]),
"21" = as.numeric(dist_m_Group_11[, 7]),
"24" = as.numeric(dist_m_Group_11[, 8]),
"25" = as.numeric(dist_m_Group_11[, 9]),
"62" = as.numeric(dist_m_Group_11[, 10]),
"66" = as.numeric(dist_m_Group_11[, 11]),
"69" = as.numeric(dist_m_Group_11[, 12]),
"78" = as.numeric(dist_m_Group_11[, 13]),
"99" = as.numeric(dist_m_Group_11[, 14]),
"100" = as.numeric(dist_m_Group_11[, 15]),
"mont" = as.numeric(dist_m_Group_11[, 16]),
"be" = as.numeric(dist_m_Group_11[, 17]),
"bee"= as.numeric(dist_m_Group_11[, 18]),
"beee" = as.numeric(dist_m_Group_11[, 19]),
"beeee" = as.numeric(dist_m_Group_11[, 20]),
"ta" = as.numeric(dist_m_Group_11[, 21]),
"taa" = as.numeric(dist_m_Group_11[, 22]),
"taaa" = as.numeric(dist_m_Group_11[, 23]),
"taaaa" = as.numeric(dist_m_Group_11[, 24]),
"taaaaa" = as.numeric(dist_m_Group_11[, 25]),
"taaaaaa" = as.numeric(dist_m_Group_11[, 26]),
"taaaaaaa" = as.numeric(dist_m_Group_11[, 27]),
"taaaaaaaa" = as.numeric(dist_m_Group_11[, 28]),
"taaaaaaaaa" = as.numeric(dist_m_Group_11[, 29]),
"wau" = as.numeric(dist_m_Group_11[, 30]),
"co" = as.numeric(dist_m_Group_11[, 31]),
"cern" = as.numeric(dist_m_Group_11[, 32]),
"cer" = as.numeric(dist_m_Group_11[, 33]))
...
"h" = as.numeric(dist_m_Group_unknown[, 3]),
"an" = as.numeric(dist_m_Group_unknown[, 4]),
"va" = as.numeric(dist_m_Group_unknown[, 5]),
"sa" = as.numeric(dist_m_Group_unknown[, 6]),
"cu" = as.numeric(dist_m_Group_unknown[, 7]),
"hol" = as.numeric(dist_m_Group_unknown[, 8]),
"arr" = as.numeric(dist_m_Group_unknown[, 9]),
...
"9" = as.numeric(dist_m_Group_unknown[, 14]),
"22" = as.numeric(dist_m_Group_unknown[, 15]),
"23" = as.numeric(dist_m_Group_unknown[, 16]),
"35" = as.numeric(dist_m_Group_unknown[, 17]),
"47"= as.numeric(dist_m_Group_unknown[, 18]),
"60" = as.numeric(dist_m_Group_unknown[, 19]),
"68" = as.numeric(dist_m_Group_unknown[, 20]),
"104" = as.numeric(dist_m_Group_unknown[, 21]),
"10" = as.numeric(dist_m_Group_unknown[, 22]),
"Al" = as.numeric(dist_m_Group_unknown[, 23]),
"Hi" = as.numeric(dist_m_Group_unknown[, 24]),
"In" = as.numeric(dist_m_Group_unknown[, 25]),
"Sand" = as.numeric(dist_m_Group_unknown[, 26]),
"Sani" = as.numeric(dist_m_Group_unknown[, 27]),
"st" = as.numeric(dist_m_Group_unknown[, 28]),
"howard" = as.numeric(dist_m_Group_unknown[, 29]),
"chi" = as.numeric(dist_m_Group_unknown[, 30]),
"flo" = as.numeric(dist_m_Group_unknown[, 31]),
"floyd" = as.numeric(dist_m_Group_unknown[, 32]),
"st" = as.numeric(dist_m_Group_unknown[, 33]),
"sto" = as.numeric(dist_m_Group_unknown[, 34]),
"stoo" = as.numeric(dist_m_Group_unknown[, 35]),
"stooo" = as.numeric(dist_m_Group_unknown[, 36]),
"stoooo" = as.numeric(dist_m_Group_unknown[, 37]),
"sh" = as.numeric(dist_m_Group_unknown[, 38]),
"shh" = as.numeric(dist_m_Group_unknown[, 39]),
"shhh" = as.numeric(dist_m_Group_unknown[, 40]),
"shhhh" = as.numeric(dist_m_Group_unknown[, 41]),
"shhhhh" = as.numeric(dist_m_Group_unknown[, 42]),
"shhhhhh" = as.numeric(dist_m_Group_unknown[, 43]),
"shhhhhhh" = as.numeric(dist_m_Group_unknown[, 44]),
"shhhhhhhh" = as.numeric(dist_m_Group_unknown[, 45]),
"wau" = as.numeric(dist_m_Group_unknown[, 46]),
"la" = as.numeric(dist_m_Group_unknown[, 47]),
"laa" = as.numeric(dist_m_Group_unknown[, 48]),
"laaa" = as.numeric(dist_m_Group_unknown[, 49]),
"laaaa" = as.numeric(dist_m_Group_unknown[, 50]),
"laaaaa" = as.numeric(dist_m_Group_unknown[, 51]),
"laaaaaa" = as.numeric(dist_m_Group_unknown[, 52]),
"laaaaaaa" = as.numeric(dist_m_Group_unknown[, 53]),
"laaaaaaaa" = as.numeric(dist_m_Group_unknown[, 54]),
"laaaaaaaaa" = as.numeric(dist_m_Group_unknown[, 55]),
"laaaaaaaaaa" = as.numeric(dist_m_Group_unknown[, 56 ]),
"co" = as.numeric(dist_m_Group_unknown[, 57]),
"cer" = as.numeric(dist_m_Group_unknown[, 58]))
