...
```{r}
###
WM <- read.csv("data/WM-fixingproductnamesID2416.csv", stringsAsFactors = FALSE)# Making the columns as 
...
WM$long <- as.numeric(WM$long)# Transforming long variables to numeric
#WM<- WM[-1293, ]
...
aaaa <-  wm1___ %>%  group_by(State, Origin) %>% summarize(n=n())
